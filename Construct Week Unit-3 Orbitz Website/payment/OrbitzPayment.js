...
console.log(payment)
let rate = payment.ratePlans[0].price.current ; 
function showPrice(){

    document.getElementById("roomPrice").innerText = rate ; 
    document.getElementById("totalPrice").innerText = rate ; 
    document.getElementById("firstPayment").innerText = rate ; 
